...
const Skills = () => {
  return (
    <div className="skills px-4 md:px-20 py-10" id="skills">
      <h1 className="skill-heading text-center text-3xl md:text-4xl font-bold mb-10">
        Skills
      </h1>
      <ul className="flex flex-wrap justify-center md:justify-start gap-4 sm:gap-6 text-lg sm:text-xl md:text-2xl">
